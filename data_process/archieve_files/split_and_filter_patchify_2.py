...
import pdb
with open("/ailab/user/wuguocheng/Astro_SR/data_process/split_file/datasetlist.txt", "r") as f:
    lines = f.readlines()
filtered_data = []
...
patch_size = 256
stride = patch_size // 2
train_patch_dir = "/ailab/user/wuguocheng/Astro_SR/dataset/train_patches"
eval_patch_dir = "/ailab/user/wuguocheng/Astro_SR/dataset/eval_patches"
