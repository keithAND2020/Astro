...
fits_filepath = "/ailab/group/pjlab-ai4s/ai4astro/Deep_space_explore/hst_data/hst_9476_20_acs_wfc_total_j8f620/hst_9476_20_acs_wfc_total_j8f620_drc.fits.gz"
...
img_data = img_data[128:128+256,2944:2944+256]
...
plt.xlabel("X (pixels)")
plt.ylabel("Y (pixels)")
plt.savefig('//ailab/user/zhuangguohang/ai4stronomy/Astro_SR/vis/result_fits2.png')